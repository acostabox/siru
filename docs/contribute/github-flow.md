<!-- Space: Projects -->
<!-- Parent: Siru -->
<!-- Title: Contributing GithubFlow Siru -->
<!-- Label: Siru -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to siru project on [GitHub](https://github.com/acostabox/siru), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/acostabox/siru/pulls).
...
To follow the instructions in this guide and start contributing to siru project on GitHub:
...
```bash
git remote add upstream  https://github.com/acostabox/siru.git
```

Now your **upstream** points to **acostabox/siru**.
...
git fetch upstream # assuming upstream is acostabox/siru
...
All merge requests are automatically tested using [Github Actions](https://github.com/acostabox/siru/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
